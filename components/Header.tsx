      ...
      <div className="container mx-auto px-6 md:px-12 flex justify-between items-center">
        ...
        <a href="#" className="group flex items-center gap-3 outline-none">
          ...
          <div className="flex flex-col justify-center">
            <h1 className={`font-serif font-bold tracking-tight leading-none transition-colors duration-300 text-gold-dark ${isScrolled ? 'text-lg md:text-xl' : 'text-xl md:text-3xl'
              }`}>
              Golden Tower
            </h1>
            <span className={`text-gold-dark uppercase tracking-[0.25em] leading-none mt-1 transition-all duration-300 ${isScrolled ? 'text-[0.55rem] md:text-[0.6rem]' : 'text-[0.65rem] md:text-xs'
              }`}>
              Spa & Wellness
            </span>
          </div>
