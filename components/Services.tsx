      ...
      if (window.innerWidth < 768 && cardsRef.current && containerRef.current) {
        ...
        const tl = gsap.timeline({
          scrollTrigger: {
            ...
            pin: true,
            pinSpacing: true, // Prevent gaps
            scrub: 0.5, // Thinner scrub
            anticipatePin: 1,
            invalidateOnRefresh: true,
            // Explicitly force dark background on the pin-spacer
            onEnter: () => {
    ...
    <section id="services" className="py-24 bg-gradient-to-b from-white via-[#faf9f5] to-cream/50 relative overflow-hidden">
      <div className="container mx-auto px-6 md:px-12">
        ...
        <div
          id="express"
          ref={containerRef}
          className="relative mt-24 mb-24 py-32 bg-[#1A1A1A] w-screen left-1/2 -ml-[50vw] px-6 md:px-12 overflow-hidden"
        ...
        >
          ...
          <div className="container mx-auto relative z-10">
            <div className="flex flex-col mb-16 lg:text-center">
            ...
            {loading ? (
              ...
              <div className="relative">
                ...
                <div
                  ref={cardsRef}
                  className="md:hidden relative h-[80vh] w-full flex items-center justify-center"
                >
                  {expressMassages.map((service, index) => (
                    <div
                      key={service.id}
                      className="express-card absolute w-full max-w-[92vw] overflow-hidden"
                      style={{
                        zIndex: expressMassages.length - index,
                        opacity: 1 // Init as fully visible stack
                      }}
                    >
                      <div className="bg-[#111111] border border-gold/30 rounded-[2.5rem] p-6 shadow-[0_20px_60px_rgba(0,0,0,0.8)] relative overflow-hidden h-[60vh] flex flex-col ring-1 ring-white/5">
                        <div className="relative h-[55%] w-full overflow-hidden mb-6 rounded-2xl shadow-2xl ring-1 ring-white/10 flex-shrink-0">
                          <img
                            src={service.image_url}
                            alt={`Express therapy: ${service.title}`}
                            loading="lazy"
                          ...
                          />
                          <div className="absolute top-4 left-4 bg-gold text-white px-3 py-1 text-[10px] uppercase font-black tracking-widest rounded-full shadow-lg z-20">
                        ...
                        <div className="flex-1 flex flex-col justify-between">
                          <div>
                            ...
                            <p className="text-cream/50 text-[11px] font-light leading-relaxed line-clamp-3 italic">
                              {service.description}
                            </p>
                          </div>
